                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 mx-md-auto">
                            <h1>Knowledgebase</h1>
                            <p class="lead text-muted">Sed eget orci eleifend enim mattis suscipit. Suspendisse potenti non
                                ipsum.</p>
                            <form>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6">
                        <div class="topics-wrapper border-style">
                            <h3><a href="#"><span class="icon icon-circle-o text-blue"></span>Introduction</a></h3>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="topics-wrapper border-style">
                            <h3><a href="#"><span class="icon icon-circle-o text-red"></span>Intallation &amp;
                                    Activation</a>
                            </h3>
                            <ul class="topics-list">
                                <li><a href="single.html"> How to use this documentation? </a>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="topics-wrapper border-style">
                            <h3><a href="#"><span class="icon icon-circle-o text-green"></span>Import &amp; Export</a>
                            </h3>
                            <ul class="topics-list">
                                <li><a href="single.html"> How to use this documentation? </a>
                                </li>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="topics-wrapper border-style">
                            <h3><a href="#"><span class="icon icon-circle-o text-purple"></span>Settings &amp;
                                    Configuration</a>
                            </h3>
                            <ul class="topics-list">
                                <li><a href="single.html"> How to use this documentation? </a>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="topics-wrapper border-style">
                            <h3><a href="#"><span class="icon icon-circle-o text-black"></span>API Guide Lines</a>
                            </h3>
                            <ul class="topics-list">
                                <li><a href="single.html"> How to use this documentation? </a>
                                </li>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="topics-wrapper border-style">
                            <h3><a href="#"><span class="icon icon-circle-o text-yellow"></span> Payment Methods</a>
                            </h3>
                            <ul class="topics-list">
                                <li><a href="single.html"> How to use this documentation? </a>
                                </li>
